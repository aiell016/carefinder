...
// var tokenName='CFToken'
// var tokenValue=localStorage.getItem(tokenName)
...
axios.get('https://server-cli-api.herokuapp.com/api/hospitals/state/WI',auth).then(response => { 
